...
class ClassTest6 {
	...
	/*
	 * Léinstruction invoque le constructeur avec un argument entier (2003). Ce dernier appelle explicitement le
	 * constructeur sans arguments (this()) qui imprime éCiaoé, et ensuite le message éBonjour 2003é est imprimé.
	 */
    }
}
