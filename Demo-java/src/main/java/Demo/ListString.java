...
/**
 * « Ecrire une classe Java avec 3 méthodes statiques pour manipuler une collection de chaîne. Une méthode pour
 * transformer une liste de String en une seule String, chaque élément étant séparé par une virgule. deuxième méthode
 * pour afficher en ordre inverse le contenu de ma liste de chaine. Enfin une troisième méthode pour mettre en majuscule
 * chacune des Strings de ma liste. » réalisable en 8-10 minutes, 2 mn si vous êtes très fort et 20 mn si vous êtes
 * vraiment pas bon.
 * 
 * @author a614412
 */
