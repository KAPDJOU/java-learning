 ...
 * @author dell
 */
public class SortArrayOfBookByProperty {
    public static void main(String[] args) {
	Library library = new Library(new Book[] { new Book("1984", 123), new Book("I, Robot", 152),
		new Book("Harry Potter and the Philosopher's Stone", 267),
		new Book("Harry Potter and the Goblet of Fire", 759), new Book("The Bible", 1623) });
